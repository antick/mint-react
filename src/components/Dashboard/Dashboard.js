            ...
            <div className="flex">
              <div className="flex flex-col p-8 w-3/4">
                ...
                <p className="pt-3 text-sm text-gray-700">
                  Today is <em>{today}</em> and it is time to do something good with your life. Build stuff, help people, solve problems, learn new stuff,
                  exercise, meditate. Just do it!
                </p>
              ...
              <div className="weather-widget flex flex-col rounded-lg my-6 mr-6 p-8 bg-red-300 text-white w-2/4">
                ...
                <div className="flex flex-row pt-4 justify-center">
                  <div>
                    <Svg name="air" classes="w-20 h-20 text-white" />
        ...
        <div className="flex mt-6">
          <div className="w-2/3 font-sans text-gray-700">
            <div className="flex border bg-white border-gray-200 rounded-lg h-48">
              ...
              <div className="today-event-widget flex flex-col rounded-lg rounded-l-full p-8 pr-6 text-gray-600 w-1/4 border-l text-right">
