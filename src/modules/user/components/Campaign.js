...
const Campaign = () => {
  ...
  return (
    <section className="flex flex-col w-full text-gray-800 min-h-screen">
      ...
      <main className="dark:bg-gray-900 transition duration-500 ease-in-out">
        <div className="px-24 pb-4 text-gray-700 dark:text-gray-500 transition duration-500 ease-in-out">
          <h2 className="text-4xl font-medium capitalize">Campaigns</h2>
          <div className="mt-1 mb-4 flex items-center justify-between">
            <span className="text-sm">
              Balance <strong>677 USD</strong>
            </span>

            <div className="flex items-center select-none">
              <span className="hover:text-teal-500 cursor-pointer mr-3">
            ...
            <button
              className="flex items-center focus:outline-none border rounded-full py-2 px-6 leading-none border-gray-500 select-none hover:text-gray-50 hover:bg-teal-600">
            ...
            <div className="flex items-center select-none">
              <span>Filter</span>
              <button className="ml-3 bg-gray-400 dark:bg-gray-600 dark:text-gray-400 rounded-full p-2 focus:outline-none hover:text-gray-50 hover:bg-teal-600 transition duration-500 ease-in-out">
              ...
              <button className="ml-2 bg-gray-400 dark:bg-gray-600 dark:text-gray-400 rounded-full p-2 focus:outline-none hover:text-gray-50 hover:bg-teal-600 transition duration-500 ease-in-out">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
          ...
          <div className="border dark:border-gray-700 transition duration-500 ease-in-out"/>

          <div className="flex flex-col mt-2">
            <div className="flex flex-row mt-2">
              <div className="flex w-full items-center justify-between bg-white dark:bg-gray-800 px-8 py-6">
                <div className="flex">
                  ...
                  <div className="flex flex-col ml-6">
                    ...
                    <div className="mt-4 flex">
                      <button className="flex items-center focus:outline-none border rounded-full py-2 px-6 leading-none border-gray-500 dark:border-gray-600 select-none hover:bg-teal-400 hover:text-white dark-hover:text-gray-200">
                      ...
                      <button className="flex items-center ml-4 focus:outline-none border rounded-full py-2 px-6 leading-none border-gray-700 dark:border-teal-600 select-none hover:bg-teal-400 hover:text-white dark-hover:text-gray-200">
                ...
                <div className="flex flex-col -mt-10 mr-20">
                  <span className="font-semibold text-green-500 dark:text-green-300">Utilized</span>
                  <span className="text-sm text-gray-700 dark:text-gray-400 mt-2">$620</span>
                </div>
              </div>
              <div className="text-center flex flex-col items-center justify-center bg-white dark:bg-gray-800 dark:text-gray-300 ml-1 px-12 cursor-pointer hover:bg-teal-200 dark-hover:bg-teal-500 rounded-lg">
                <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
